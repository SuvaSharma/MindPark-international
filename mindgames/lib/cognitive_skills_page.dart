...
class CognitiveSkillsPage extends StatefulWidget {
  const CognitiveSkillsPage({super.key});

  @override
  State<CognitiveSkillsPage> createState() => _CognitiveSkillsPageState();
}

class _CognitiveSkillsPageState extends State<CognitiveSkillsPage> {
  int index = 1;
  ...
  List<Map<String, dynamic>> levelTiles = [
    {
      "levelName": "Maze Magic",
      "levelImage": "maze_magic.jpeg",
      "levelPage": const MazeMagicDemoPage(),
    },
  ];
