...
class CPTdemoPage extends StatefulWidget {
  const CPTdemoPage({super.key});

  @override
  State<CPTdemoPage> createState() => _CPTdemoPageState();
}

class _CPTdemoPageState extends State<CPTdemoPage> {
  String _popupText = '';
    ...
    showDialog(
      ...
      builder: (context) {
        return const WelcomeDialog(
          title: 'Welcome!',
          message: 'Press the buzzer for every letter except \"X\".',
          imagePath: 'assets/images/cpt-intro.gif',
        );
      },
    );
  }
              ...
              child: Container(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      TextButton(
                        onPressed: () {
                          ...
                          Navigator.pushReplacement(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                    const CPTPage()), // Navigate to main game
                          );
                        },
                        child: Container(
                          decoration: BoxDecoration(
                      ...
                      //       MaterialPageRoute(
                      //           builder: (context) =>
                      //               const CPTPage()), // Navigate to LevelScreen
                      //     );
                      //   },
                      //   child: SizedBox(
