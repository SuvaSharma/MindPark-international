...
import 'package:mindgames/widgets/maze/src/models/cell.dart';
import 'package:mindgames/widgets/maze/src/models/item_position.dart';
import 'package:mindgames/widgets/maze/src/models/stack.dart';
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (backgroundImage != null) {
      canvas.drawImageRect(
        ...
        Rect.fromLTWH(0, 0, columns * _cellSize, rows * _cellSize),
        Paint(),
      );
    }

    // Draw walls and other maze elements
    for (var v in _cells) {
      for (var cell in v) {
        if (cell.topWall) {
          canvas.drawLine(
